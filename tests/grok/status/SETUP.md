...
**Feature**: kck grok status thin CLI
...
const fixtureKckStatusSessionID = "019f283a-bbbb-7bbb-bbbb-bbbbbbbbbb01"
...
func writeKckStatusSession(t *testing.T, req *Request) string {
	...
	summary := map[string]any{
		...
		"generated_title": "kck status fixture",
