...
**Feature**: kck grok send thin CLI

```
run.MainWith(Options{Args: ["grok","send",…], GrokHome, GrokSendOpts})
  -> sessions.RunSend
```
...
const fixtureKckSendSessionID = "019f283a-cccc-7ccc-cccc-cccccccccc01"
...
func writeKckSendSession(t *testing.T, req *Request) {
	...
	summary := map[string]any{
		...
		"generated_title": "kck send fixture",
