...
**Feature**: kck grok open thin CLI

```
run.MainWith(Options{Args: ["grok","open",…], GrokHome, GrokOpenOpts})
  -> sessions.RunOpen
```
...
const fixtureKckOpenSessionID = "019f283a-ffff-7fff-ffff-ffffffffff01"
...
func writeKckOpenSession(t *testing.T, req *Request) {
	...
	summary := map[string]any{
		...
		"generated_title": "kck open fixture",
