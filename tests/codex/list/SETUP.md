...
**Feature**: kck codex list thin CLI

```
run.MainWith(Options{Args: ["codex","list",…], CodexHome, CodexListLiveOpts})
  -> sessions.RunListLive
```
...
const fixtureKckListSessionID = "019f283a-ffff-7fff-ffff-ffffffffff41"
...
func writeKckListSession(t *testing.T, req *Request) {
	t.Helper()
	sessionID := req.SessionID
	if sessionID == "" {
		sessionID = fixtureKckListSessionID
...
func addLiveCodexList(req *Request, pid int, tty string) {
...
func oneITermTabList() []iterm2.SessionRef {
