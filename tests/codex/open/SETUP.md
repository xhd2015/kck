...
**Feature**: kck codex open thin CLI

```
run.MainWith(Options{Args: ["codex","open",…], CodexHome, CodexOpenOpts})
  -> sessions.RunOpen
```
...
const fixtureKckOpenSessionID = "019f283a-ffff-7fff-ffff-ffffffffff51"
...
func writeKckOpenSession(t *testing.T, req *Request) {
	t.Helper()
	sessionID := req.SessionID
	if sessionID == "" {
		sessionID = fixtureKckOpenSessionID
...
func addLiveCodexOpen(req *Request, pid int, tty string) {
...
func oneITermTabOpen() []iterm2.SessionRef {
